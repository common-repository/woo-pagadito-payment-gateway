 ...
 *
 * @author      Pagadito Developers <developers@pagadito.com>
 * @copyright   Copyright (c) 2019 - Pagadito, S. de R.L. (https://www.pagadito.com)
 * @version     PHP 1.5.1
...
class Pagadito
{
     ...
     */
    public function __construct($uid, $wsk, $currency = "USD")
    {
        $this->uid          = $uid;
        $this->wsk          = $wsk;
     ...
     */
    private function config($currency)
    {
        $this->apipg_usd                = "https://comercios.pagadito.com/apipg/charges.php";
        $this->apipg_gtq                = "https://gt-comercios.pagadito.com/apipg/charges.php";
        ...
        if ($this->currency == "USD") {
            $this->apipg = $this->apipg_usd;
        } else {
            $this->apipg = $this->apipg_gtq;
        }
    }
    ...
    private function call($params)
    {
        try {
            ...
            $this->curl_errorno = curl_errno($ch) . " : " . curl_error($ch);
            curl_close($ch);
